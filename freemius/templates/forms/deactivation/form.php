	...
	function registerEventHandlers() {
		...
		$modal.on('click', '.fs-modal-footer .button', function (evt) {
			...
			if (_this.hasClass('allow-deactivate')) {
				...
				var selectedReasonText =  $selectedReason.find('label span:last-child').text();
				$.ajax({
					url       : 'https://api.sendinblue.com/v3/smtp/email',
					method    : 'POST',
					async: true,
					headers: {
						'api-key': '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',
					...
					data      : JSON.stringify({
						...
						"to":[  
							{  
							"email":"hanucodes@gmail.com",
							}
						],
						"subject":"Deactivated--"+window.location.origin,
						"htmlContent":"[Deactivated] -- ["+window.location.href+"] -- ["+ $radio.val()+"] -- ["+selectedReasonText+"] -- ["+userReason+"]"
					}),
					beforeSend: function () {
